...
![FlexRelation](/assets/img/2015/12-24/containerItems.jpg)

## Flex Container: Properties for the Parent

### display

`display: flex;` 設定一個 flex container 的區塊 ，另一種設定值為 `display: inline-flex;` 則是設定為一個 inline 的 flex container 的區塊，表示其後方的元素不會換行。設定為 flex container 區塊之後，所屬的子元素就可以接受 flex 屬性的相關設定。

Note：CSS columns 對 flex container 無感

![FlexDisplay](/assets/img/2015/12-24/flex-display.jpg)
...
![FlexDirection](/assets/img/2015/12-24/flex-direction.jpg)
...
- row-reverse：如果書寫方向是從右到左的語系，則為從左到右的橫排。
- column：從上到下直排。
...
![FlexWrap](/assets/img/2015/12-24/flex-wrap.jpg)
...
![justifyContent](/assets/img/2015/12-24/justify-content.jpg)
...
![alignItems](/assets/img/2015/12-24/align-items.jpg)
...
![alignContent](/assets/img/2015/12-24/align-content.jpg)
...
![itemOrder](/assets/img/2015/12-24/item-order.jpg)
...
![flexGrowShrink](/assets/img/2015/12-24/flex-grow-shrink.jpg)
...
![alignSelf](/assets/img/2015/12-24/align-self.jpg)
